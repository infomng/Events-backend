package com.events.modules.country.enumeration;
...
public enum PaysEnum {
    ...
    PaysEnum(String name, String code) {
        this.name = name;
        this.code = code;
    }

    public static PaysEnum getByCode(String code) {
        if (code == null) {
            return null;
        }
        for (PaysEnum pays : PaysEnum.values()) {
    ...
    public static PaysEnum getByName(String name) {
        if (name == null) {
            return null;
        }
        for (PaysEnum pays : PaysEnum.values()) {
            if (pays.getName().equalsIgnoreCase(name)) {
                return pays;
            }
        }
        return null;
